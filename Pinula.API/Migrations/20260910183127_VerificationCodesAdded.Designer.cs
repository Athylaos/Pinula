...
namespace Pinula.API.Migrations
{
    ...
    [Migration("20260910183127_VerificationCodesAdded")]
    partial class VerificationCodesAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pinula.API.Models.Ingredient", b =>
                {
                    ...
                    b.Property<DateTime>("IngredientCreated")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(0)
                        .HasColumnType("timestamp(0) with time zone")
                        .HasColumnName("ingredient_created")
            ...
            modelBuilder.Entity("Pinula.API.Models.InventoryItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_inventory_items_group_id");

                    b.HasIndex("IngredientId")
                        .HasDatabaseName("ix_inventory_items_ingredient_id");
            ...
            modelBuilder.Entity("Pinula.API.Models.InventoryMealPlanAllocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("MealPlanIngredientId")
                        .HasColumnType("uuid")
                        .HasColumnName("meal_plan_ingredient_id");

                    b.HasKey("Id")
                        .HasName("pk_inventory_meal_plan_allocations");

                    b.HasIndex("InventoryItemId")
                        .HasDatabaseName("ix_inventory_meal_plan_allocations_inventory_item_id");

                    b.HasIndex("MealPlanIngredientId")
                        .HasDatabaseName("ix_inventory_meal_plan_allocations_meal_plan_ingredient_id");

                    b.ToTable("inventory_meal_plan_allocations", (string)null);
                });
            ...
            modelBuilder.Entity("Pinula.API.Models.MealPlanIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_meal_plan_ingredients");

                    b.HasIndex("IngredientId")
                        .HasDatabaseName("ix_meal_plan_ingredients_ingredient_id");

                    b.HasIndex("MealPlanId")
                        .HasDatabaseName("ix_meal_plan_ingredients_meal_plan_id");

                    b.HasIndex("UnitId")
                        .HasDatabaseName("ix_meal_plan_ingredients_unit_id");

                    b.ToTable("meal_plan_ingredients", (string)null);
                });
            ...
            modelBuilder.Entity("Pinula.API.Models.ShoppingCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Pinula.API.Models.ShoppingListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("GroupId")
                        .HasDatabaseName("ix_shopping_list_items_group_id");
                    ...
                    b.HasIndex("MealPlanIngredientId")
                        .IsUnique()
                        .HasDatabaseName("ix_shopping_list_items_meal_plan_ingredient_id");

                    b.HasIndex("ShoppingCategoryId")
                        .HasDatabaseName("ix_shopping_list_items_shopping_category_id");
            ...
            modelBuilder.Entity("Pinula.API.Models.VerificationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Email", "Code", "Type", "IsUsed")
                        .HasDatabaseName("ix_verification_codes_email_code_type_is_used");
            ...
            modelBuilder.Entity("Pinula.API.Models.Ingredient", b =>
                {
                    b.HasOne("Pinula.API.Models.Ingredient", "BaseIngredient")
            ...
            modelBuilder.Entity("Pinula.API.Models.InventoryItem", b =>
                {
                    b.HasOne("Pinula.API.Models.Group", "Group")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inventory_items_groups_group_id");
                    ...
                    b.HasOne("Pinula.API.Models.Ingredient", "Ingredient")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inventory_items_ingredients_ingredient_id");
            ...
            modelBuilder.Entity("Pinula.API.Models.InventoryMealPlanAllocation", b =>
                {
                    b.HasOne("Pinula.API.Models.InventoryItem", "InventoryItem")
                        .WithMany("Allocations")
                        .HasForeignKey("InventoryItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inventory_meal_plan_allocations_inventory_items_inventory_i");

                    b.HasOne("Pinula.API.Models.MealPlanIngredient", "MealPlanIngredient")
                        .WithMany("Allocations")
                        .HasForeignKey("MealPlanIngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inventory_meal_plan_allocations_meal_plan_ingredients_meal_");

                    b.Navigation("InventoryItem");

                    b.Navigation("MealPlanIngredient");
                });
            ...
            modelBuilder.Entity("Pinula.API.Models.MealPlanIngredient", b =>
                {
                    b.HasOne("Pinula.API.Models.Ingredient", "Ingredient")
                        ...
                        .HasForeignKey("IngredientId")
                        .IsRequired()
                        .HasConstraintName("fk_meal_plan_ingredients_ingredients_ingredient_id");
                    ...
                    b.HasOne("Pinula.API.Models.Unit", "Unit")
                        ...
                        .HasForeignKey("UnitId")
                        .IsRequired()
                        .HasConstraintName("fk_meal_plan_ingredients_units_unit_id");
            ...
            modelBuilder.Entity("Pinula.API.Models.ShoppingListItem", b =>
                {
                    b.HasOne("Pinula.API.Models.Group", "Group")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shopping_list_items_groups_group_id");
                    ...
                    b.HasOne("Pinula.API.Models.MealPlanIngredient", "MealPlanIngredient")
                        ...
                        .HasForeignKey("Pinula.API.Models.ShoppingListItem", "MealPlanIngredientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("fk_shopping_list_items_meal_plan_ingredients_meal_plan_ingredi");

                    b.HasOne("Pinula.API.Models.ShoppingCategory", "ShoppingCategory")
                        .WithMany("ShoppingListItems")
                        .HasForeignKey("ShoppingCategoryId")
                        .HasConstraintName("fk_shopping_list_items_shopping_categories_shopping_category_id");
