...
namespace Pinula.API.Migrations
{
    ...
    [Migration("20260803120109_MealPlanIngredientAdded")]
    partial class MealPlanIngredientAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pinual.API.Models.MealPlanIngredient", b =>
                {
                    ...
                    b.HasKey("MealPlanId", "IngredientId")
                        .HasName("pk_meal_plan_ingredient");

                    b.HasIndex("IngredientId")
                        .HasDatabaseName("ix_meal_plan_ingredient_ingredient_id");

                    b.HasIndex("UnitId")
                        .HasDatabaseName("ix_meal_plan_ingredient_unit_id");

                    b.ToTable("meal_plan_ingredient", (string)null);
                });
            ...
            modelBuilder.Entity("Pinual.API.Models.MealPlanIngredient", b =>
                {
                    b.HasOne("Pinual.API.Models.Ingredient", "Ingredient")
                        ...
                        .HasForeignKey("IngredientId")
                        .IsRequired()
                        .HasConstraintName("fk_meal_plan_ingredient_ingredients_ingredient_id");

                    b.HasOne("Pinual.API.Models.MealPlan", "MealPlan")
                        .WithMany("MealPlanIngredients")
                        .HasForeignKey("MealPlanId")
                        .IsRequired()
                        .HasConstraintName("fk_meal_plan_ingredient_meal_plans_meal_plan_id");

                    b.HasOne("Pinual.API.Models.Unit", "Unit")
                        .WithMany("MealPlanIngredients")
                        .HasForeignKey("UnitId")
                        .IsRequired()
                        .HasConstraintName("fk_meal_plan_ingredient_units_unit_id");
