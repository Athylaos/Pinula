...
namespace Pinula.API.Migrations
{
    ...
    [Migration("20260624072955_UpdateToIngredientSystem")]
    partial class UpdateToIngredientSystem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pinula.Shared.Models.Ingredient", b =>
                {
                    ...
                    b.HasIndex("ShoppingCategoryId")
                        .HasDatabaseName("ix_ingredients_type_id");
            ...
            modelBuilder.Entity("Pinula.Shared.Models.Ingredient", b =>
                {
                    ...
                    b.HasOne("Pinula.Shared.Models.ShoppingCategory", "ShoppingCategory")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_ingredients_ingredient_type_type_id");
